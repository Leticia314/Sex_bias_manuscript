...
#Split_objects directory would contain a separate folder for each of the samples containing the following files: barcodes.tsv, features.tsv and matrix.mtx (example can be downloaded from:  https://heibox.uni-heidelberg.de/d/34ace5842ae34f798277/).
...
# Annotated dataset can be downloaded from:  https://heibox.uni-heidelberg.de/d/34ace5842ae34f798277/.
