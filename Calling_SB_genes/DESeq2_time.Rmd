...
counts_dir <- "~/R_analyses/040122_new_git/homework_1/counts/"
raw_counts_dir <- "~/R_analyses/260421_DESeq2/counts/"
...
prepro_data_DESeq2 <- function(sp, ts){
  ...
  meta_sp<- read_csv(paste0("../metadata/", sp, ".sampleTable.csv"))
